...
public class PantallaAlojamiento extends JFrame {

    public PantallaAlojamiento(String nombreUsuario) {
        setTitle("Gestión de Alojamientos");
        setSize(400, 300);
        setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
        setLayout(new BorderLayout());

        JLabel lblBienvenida = new JLabel("Bienvenido a Gestión de Alojamientos, " + nombreUsuario, SwingConstants.CENTER);
